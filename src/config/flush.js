...
export const flushConfig = {
  ...
  elements: [
    ...
    row(['preheat_2'], 1840, 1171, 'nw', C.slabel, () => t('Flushing'), { size: F.set }),
    row(['preheat_2'], 2500, 1171, 'ne', C.sval, (l) => `${n0(l.runElapsed)} ${t('seconds')}`, { size: F.set }),
    row(['preheat_2'], 1840, 1241, 'nw', C.slabel, () => t('Flow rate'), { size: F.set }),
    row(['preheat_2'], 2500, 1241, 'ne', C.sval, (l) => `${n1(l.flow)} mL/s`, { size: F.set }),
    row(['preheat_2'], 1840, 1311, 'nw', C.slabel, () => t('Auto-Off'), { size: F.set }),
    row(['preheat_2'], 2500, 1311, 'ne', C.sval, (l) => `${n0(l.flushSeconds)} ${t('seconds')}`, { size: F.set }),
